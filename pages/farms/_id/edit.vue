    ...
    <div class="card">
        <div class="card-header d-flex flex-column flex-lg-row bg-white">
            <div class="d-flex align-items-center">
                <router-link v-if="row" :to="`/farms/${row.id}`" class="btn btn-sm btn-default">
            ...
            <form @submit.prevent="onSubmit">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div v-if="!$v.name.required" class="invalid-feedback">กรุณากรอก ชื่อสวน</div>
                    </div>
                </div>
    ...
    methods: {
        ...
        async onSubmit () {
            ...
            this.update({
                ...
                this.$router.push(`/farms/${this.row.id}`)
            })
        },
        move (latLng) {
            this.lat = latLng.lat()
