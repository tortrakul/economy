    ...
    <div class="card">
        <div class="card-header d-flex flex-column flex-lg-row bg-white">
            <div class="d-flex align-items-center">
                <router-link to="/shops" class="btn btn-sm btn-default">
            ...
            <div class="d-flex align-items-center ml-auto">
                <router-link :to="`/shops/${shop.id}/edit`" class="btn btn-sm btn-default">
                    <Edit /> <span class="d-none d-lg-inline ml-1">แก้ไขรายละเอียดร้านค้า OTOP</span>
                </router-link>
            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="position-relative d-flex mb-2 bg-light rounded embed-responsive embed-responsive-1by1">
                        <template v-if="shop.media_1">
                            <img :src="shop.media_1.url" class="rounded img-fluid w-100" />
                            <a @click.prevent="deletingMedia(shop.media_1.id)" href="#" class="position-absolute" style="top: 6px; right: 6px;">
                    ...
                    <div class="row no-gutters">
                        <div class="col px-1">
                            ...
                            <div class="position-relative d-flex bg-light rounded embed-responsive embed-responsive-1by1">
                                <template v-if="shop.media_2">
                                    <img :src="shop.media_2.url" class="rounded img-fluid w-100" />
                                    <a @click.prevent="deletingMedia(shop.media_2.id)" href="#" class="position-absolute" style="top: 6px; right: 6px;">
                                        <span class="material-icons-outlined">close</span>
                                    </a>
                                </template>
                                <template v-else>
                        ...
                        <div class="col px-1">
                            <!-- file 3 -->
                            <div class="position-relative d-flex bg-light rounded embed-responsive embed-responsive-1by1">
                                <template v-if="shop.media_3">
                                    <img :src="shop.media_3.url" class="rounded img-fluid w-100" />
                                    <a @click.prevent="deletingMedia(shop.media_3.id)" href="#" class="position-absolute" style="top: 6px; right: 6px;">
                                        <span class="material-icons-outlined">close</span>
                                    </a>
                                </template>
                                <template v-else>
                        ...
                        <div class="col px-1">
                            <!-- file 4 -->
                            <div class="position-relative d-flex bg-light rounded embed-responsive embed-responsive-1by1">
                                <template v-if="shop.media_4">
                                    <img :src="shop.media_4.url" class="rounded img-fluid w-100" />
                                    <a @click.prevent="deletingMedia(shop.media_4.id)" href="#" class="position-absolute" style="top: 6px; right: 6px;">
                                        <span class="material-icons-outlined">close</span>
                                    </a>
                                </template>
                                <template v-else>
                ...
                <div class="col-lg-7">
                    <table class="table">
                        <tr class="d-flex flex-column d-lg-table-row">
                            <td class="border-0 text-nowrap font-weight-bold">ชื่อร้านค้า OTOP</td>
                            <td class="border-0">{{ shop.name }}</td>
                        </tr>

                        <tr class="d-flex flex-column d-lg-table-row">
                            <td class="border-0 text-nowrap font-weight-bold">เจ้าของ</td>
                            <td class="border-0">{{ shop.owner }}</td>
                        </tr>

                        <tr class="d-flex flex-column d-lg-table-row">
                            <td class="border-0 text-nowrap font-weight-bold">เบอร์โทรศัพท์</td>
                            <td class="border-0">{{ shop.tel }}</td>
                        </tr>

                        <tr class="d-flex flex-column d-lg-table-row">
                            <td class="border-0 text-nowrap font-weight-bold">ที่อยู่ร้านค้า OTOP</td>
                            <td class="border-0">
                                {{ shop.address }}
                                {{ shop.sub_district }}
                                {{ shop.district }}
                        ...
                        <tr class="d-flex flex-column d-lg-table-row">
                            ...
                            <td class="border-0">{{ shop.description }}</td>
                        </tr>
                    </table>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        deleting () {
            this.delete(this.shop.id).then(
                () => this.$router.push('/shops')
            )
        },
        deletingMedia (id) {
            this.deleteMedia(id).then(() => this.find(this.shop.id))
        },
